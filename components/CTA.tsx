...
const CTA: React.FC<CTAProps> = ({ onOpenContact }) => {
  ...
  return (
    <section id="contact" className="py-20 bg-farm-light relative overflow-hidden scroll-mt-24">
      {/* Green pattern overlay */}
      <div className="absolute inset-0 bg-farm-primary opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(circle, #2D9C5E 1px, transparent 1px)', backgroundSize: '32px 32px' }}></div>
      ...
      >
        <h2 className="text-3xl md:text-5xl lg:text-6xl font-thin text-gray-900 mb-8 tracking-tight leading-tight">
          홈쇼핑모아 / 모아농장과의 협업,<br />
          <span className="text-farm-primary font-light">지금 바로 시작하세요!</span>
        </h2>
